...
#ifndef BOING_KIT_STANDARD_SHADOW_INCLUDED
#define BOING_KIT_STANDARD_SHADOW_INCLUDED
...
{
    APPLY_BOING_REACTOR_FIELD_PER_VERTEX(v);
    //UNITY_SETUP_INSTANCE_ID(v); // already done in APPLY_BOING_REACTOR_FIELD_PER_VERTEX
    #ifdef UNITY_STANDARD_USE_STEREO_SHADOW_OUTPUT_STRUCT
...
#endif // BOING_KIT_STANDARD_SHADOW_INCLUDED
