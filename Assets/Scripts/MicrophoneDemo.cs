...
namespace Whisper.Samples
{
    ...
    public class MicrophoneDemo : MonoBehaviour
    {
        ...
        [SerializeField] private ChatEvent OnTextProcessed;
        ...
        private async void OnRecordStop(AudioChunk recordedAudio)
        {
            ...
            if (res == null || OnTextProcessed == null)// || !outputText)
            {
                return;
            }
        ...
        {
            if (!streamSegments || OnTextProcessed == null)//!outputText)
            {
                return;
            }

            OnTextProcessed.Invoke(segment.Text);
